...
public void setTotal_reculte() {
  ...
  public void applyGladiatroolVictoryBonus(short mapId)
  {
    ...
    applyGladiatroolFinalReward(mapId);
    refreshStats();
    SocketManager.GAME_SEND_STATS_PACKET(this);
  }
  ...
  private void applyGladiatroolFinalReward(short mapId)
  {
    if(mapId!=15072)
      return;
  ...
  public void unequipedObjet(GameObject o)
  {
	  if(o == null)
		  return;
    byte oldPos = (byte) o.getPosition();
    ...
    this.actualizarSetsRapido(o.getGuid(), o.getGuid(), oldPos, (byte) Constant.ITEM_POS_NO_EQUIPED);
    this.refreshStats();
    SocketManager.GAME_SEND_STATS_PACKET(this);
...
public void setOne_windows(boolean one_windows) {
  ...
  public boolean hasEquiped_chek(final int id,final int guid) {
			for (final Entry<Integer, GameObject> entry : this.objects.entrySet()) {
