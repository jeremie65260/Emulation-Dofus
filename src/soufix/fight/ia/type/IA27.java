...
public class IA27 extends AbstractNeedSpell
{
  ...
  public void apply()
  {
    if(!this.stop&&this.fighter.canPlay()&&this.count>0)
    {
      ...
      {
    	if(this.fighter.getMob().getTemplate().getId() == 1185 || this.fighter.getMob().getTemplate().getId() == 1186 ||
    			this.fighter.getMob().getTemplate().getId() == 1184 || this.fighter.getMob().getTemplate().getId() == 1187)
    		if(this.fighter.nbrInvoc != 0) {
