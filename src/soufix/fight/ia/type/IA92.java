...
public class IA92 extends AbstractNeedSpell
{

    public IA92(Fight fight, Fighter fighter, byte count)
    {
    ...
    public void apply()
    {
        if (!this.stop && this.fighter.canPlay() && this.count > 0)
        {
            ...
            // Déplacement pour se rapprocher si rien en vue
            ...
            // 🧨 Pose d'un piège si possible
            if (this.fighter.getCurPa(this.fight) > 0 && !action)
            {
                int value = Function.getInstance().trapIfPossible(this.fight, this.fighter);
            ...
            // Attaque à distance même si ennemi au CAC
