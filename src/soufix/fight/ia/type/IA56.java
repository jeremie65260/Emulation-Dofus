...
public class IA56 extends AbstractNeedSpell
{
  ...
  public void apply()
  {
    if(!this.stop&&this.fighter.canPlay()&&this.count>0)
    {
      ...
      {
        int value=Function.getInstance().attackIfPossibleCM1(this.fight,this.fighter,this.cacs,false);
        if(value!=0)
        {
          time=value;
          action=true;
      ...
      {
        int value=Function.getInstance().attackIfPossibleCM1(this.fight,this.fighter,this.cacs,true);
        if(value!=0)
        {
          time=value;
          action=true;
