...
public class ConditionParser
{
  ...
  public static boolean validConditions(Player perso, String req)
  {
    ...
    if(req.contains("Sc"))
      return true;
    if(req.contains("Pg")) // C'est les dons que l'on gagne lors des quétes d'alignement, connaissance des potions etc ... ce n'est pas encore codé !
      return false;
    if(req.contains("RA"))
  ...
  // étre é l'étape id. Elle ne doit pas étre validé et celle d'avant doivent l'étre.
