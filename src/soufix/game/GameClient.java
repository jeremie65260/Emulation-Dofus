  ...
  { 
    ...
    try
    {
      ...
      else
      {
        ...
        if(this.player.getCurMap()!=null&&(Constant.isInGladiatorDonjon(this.player.getCurMap().getId())||this.player.getCurMap().getId()==12277)&&position!=Constant.ITEM_POS_NO_EQUIPED)
        {
